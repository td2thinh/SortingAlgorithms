...
//Mergesort and Quicksort functions retrieved from: Carrano, F. M., & Henry, T. M. (2012). Data Abstraction & Problem Solving with C++: Walls and Mirrors (6th Edition) (6th ed.). Pearson.
